...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2018 at 12:15 AM
...
(3, 'Peugeot 206 GTi', '2018-10-16 16:36:53', 'Buenas!! Mi nombre es Beñat, soy de Errenteria y os presento mi pequeño proyecto, un Peugeot 206 GTi del 99, en color Shappire Blue. Por el momento esta de serie, ya que lo compre hace mes y medio (+-), pero tengo grandes ideas en mente para el. Mi intención es empezar por la suspensión, añadirle el aleron, reparar y repintar todos los defectos de chapa que tiene (que son unos cuantos), mejorar frenada, asientos... poco a poco. Un saludo a todos y espero poder compartir con vosotros los avances que vaya teniendo el dosci!'),
